...
export function ExpensesPage() {
  ...
  const categories = mapCategoriesToMain(categoriesData, "expense");
  ...
  const store: DomainStore = {
    ...
    addMainCategory: (name: string, icon: IconName) => {
      createCategory.mutate({ name, type: "expense", icon });
    },
    addSubCategory: (name: string, icon: IconName, catId: string) => {
      createCategory.mutate({ name, type: "expense", icon, parentId: parseInt(catId) });
    },
